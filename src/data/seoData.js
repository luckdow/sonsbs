...
export const seoData = {
  tr: {
    ...
    pages: {
      homepage: {
        title: "Antalya Transfer | VIP Havalimanı Transfer",
        description: "Antalya havalimanı transfer hizmeti. Güvenli, konforlu ve ekonomik. 7/24 profesyonel hizmet. Hemen rezervasyon!",
        keywords: [
          "antalya transfer",
          ...
          "antalya grup transfer",
          "antalya güvenli transfer",
          "antalya profesyonel transfer",
  ...
  en: {
    ...
    pages: {
      homepage: {
        title: "Antalya Airport Transfer | VIP Service",
        description: "Professional Antalya Airport transfer. Safe, comfortable and affordable. 24/7 service. Book now!",
        keywords: [
    ...
    pages: {
      homepage: {
        ...
        keywords: [
          ...
          "анталья транспорт",
          "анталья такси",
          "анталья групповой трансфер",
          "анталья трансфер город",
          "анталья трансфер отель",
          "анталья безопасный трансфер"
        ]
      }
    }
  },
    ...
    pages: {
      homepage: {
        ...
        keywords: [
          ...
          "antalya transport",
          "antalya taxi service",
          "antalya gruppentransfer",
          "antalya stadttransfer",
          "antalya hoteltransfer",
          "antalya sicherer transfer"
        ]
      }
    }
  },
    ...
    pages: {
      homepage: {
        ...
        keywords: [
          ...
          "antalya transport",
          "antalya serviciu taxi",
          "antalya transfer grup",
          "antalya transfer oraș",
          "antalya transfer hotel",
          "antalya transfer sigur"
        ]
      }
    }
  },
    ...
    pages: {
      homepage: {
        ...
        keywords: [
          ...
          "antalya transport",
          "antalya usługa taxi",
          "antalya transfer grupowy",
          "antalya transfer miasto",
          "antalya transfer hotel",
          "antalya transfer bezpieczny"
        ]
      }
    }
  }
...
export const generateStructuredData = (language = 'tr') => {
